...
#
# UserMixin provides the properties and methods needed by Flask-Login,
# such as is_authenticated and is_active, to support authentication
# and session management.
#
# The User model stores a user's ID, username, and a Bcrypt-hashed password.
